...
## Propósito
O propósito ao criar este site é poder estudar de forma didática e prática a linguagem ```JavaScript```, além de aprender mais sobre a construção de sites com ```HTML5``` e ```CSS3```.
